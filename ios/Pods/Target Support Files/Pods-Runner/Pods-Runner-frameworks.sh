...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_exif_rotation/flutter_exif_rotation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_sound/flutter_sound.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_splash_screen/flutter_splash_screen.framework"
